          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative">
              ...
              >
                ...
                <span className="hidden sm:block">Sabeel</span>
              </button>
              ...
              {isUserMenuOpen && (
                ...
                >
                  ...
                  <button className="flex items-center space-x-2 px-4 py-2 text-gray-700 dark:text-gray-200 hover:bg-white/10 dark:hover:bg-gray-800/50 w-full text-left">
